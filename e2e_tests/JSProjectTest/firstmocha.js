...
describe('First Mocha Test', async () => {
   ...
   let driver
   beforeEach(() => {
        driver = new Builder().forBrowser('chrome').withToken('dVQG8TQ0qCG3jKb_KIGa69b6V-xdkT_NFdsV9-VlwqY1').build()

    });

    it('should pass', async () =>{
        await driver.get("http://eaapp.somee.com/")
        // var driver = await new Builder().forBrowser('chrome').withToken('dVQG8TQ0qCG3jKb_KIGa69b6V-xdkT_NFdsV9-VlwqY1').build()
        // await driver.get("http://eaapp.somee.com/")
